...
- **9 режимів CAPTCHA**:
  - **Silent Auto-Verify** -- реальні користувачі проходять автоматично, без жодного кліку; боти бачать "Доступ заборонено"
  - **Shapes CAPTCHA** -- 60fps Canvas з рухомими геометричними фігурами, ~у 100 разів складніше для ШІ-зламу, ніж reCAPTCHA
  - **Color CAPTCHA** -- вибір правильної колірної комбінації
  - **Images CAPTCHA** -- візуальне розпізнавання зображень
  - **Digits CAPTCHA** -- числова верифікація
  - **Hold Button CAPTCHA** -- верифікація утриманням кнопки
  - **Single Button CAPTCHA** -- верифікація одним кліком
  - **reCAPTCHA v2** -- Google "Я не робот"
  - **reCAPTCHA v3** -- невидима скорингова верифікація
- **Гібридна CAPTCHA** -- комбінація будь-якої внутрішньої CAPTCHA з reCAPTCHA v3 для дворівневого невидимого захисту
