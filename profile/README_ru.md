...
- **9 режимов CAPTCHA** - Silent Auto-Verify, Shapes (60fps Canvas), Colors, Images, Digits, Hold Button, Single Button, reCAPTCHA v2/v3
- **Гибридная CAPTCHA** - комбинация внутренней CAPTCHA с reCAPTCHA v3 для двухуровневой защиты
...
|---|---|
| `botblocker-security` | Плагин WordPress - основной firewall, CAPTCHA, 2FA, мониторинг трафика |
| *(скоро)* | |
